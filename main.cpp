...
int main() {
    ...
    std::cout << "BIRCH execution time with batch size " << BATCH_SIZE << ": " << elapsed.count() << " seconds"
              << std::endl;
    ...
    elapsed = end - start;
    std::cout << "CluStream execution time with batch size " << BATCH_SIZE << ": " << elapsed.count() << " seconds"
              << std::endl;
    ...
    elapsed = end - start;
    std::cout << "EDMStream execution time with batch size " << BATCH_SIZE << ": " << elapsed.count() << " seconds"
              << std::endl;
    ...
    elapsed = end - start;
    std::cout << "SLKMeans execution time with batch size " << BATCH_SIZE << ": " << elapsed.count() << " seconds"
              << std::endl;
    ...
    elapsed = end - start;
    std::cout << "DStream execution time with batch size " << BATCH_SIZE << ": " << elapsed.count() << " seconds"
              << std::endl;
    ...
    elapsed = end - start;
    std::cout << "DenStream execution time with batch size " << BATCH_SIZE << ": " << elapsed.count() << " seconds"
              << std::endl;
